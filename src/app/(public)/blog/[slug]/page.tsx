    ...
    <main className="min-h-screen bg-bg">
        ...
        <div className="relative max-w-275">
          <BlurFade delay={0}>
            <p className="about-chapter">
              <span className="text-blue-base">{post.category}</span> / Blog
            </p>
          </BlurFade>
      ...
      <section className="px-6 sm:px-8 md:px-16 pb-24">
        <div className="max-w-275 blog-post-layout">
            ...
            {post.sections.map((section, sectionIndex) => (
              <BlurFade key={section.heading} delay={sectionIndex * 80}>
                <section className="blog-post-section">
                  <h2 className="blog-post-section-title">{section.heading}</h2>

                  {getBlogSectionBlocks(section).map((block, blockIndex) => {
                    ...
                    const useOptimizedSectionImage = isOptimizedBlogImageSource(
                      block.image.src,
                    );
          ...
          <aside className="blog-post-aside" aria-label="Conteudo relacionado">
