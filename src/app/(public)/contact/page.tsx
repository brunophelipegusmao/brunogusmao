        ...
        <div className="relative max-w-350">
          <BlurFade delay={0}>
            <p className="about-chapter">
              <span className="text-blue-base">Canal direto</span> / Contato
            </p>
          </BlurFade>
          ...
          <BlurFade delay={420}>
            <p className="contact-hero-lead">
              Aqui o contato vai direto ao ponto: voce escreve na pagina, eu
              recebo no WhatsApp. Sem email, sem caixa postal, sem formularios
              que terminam esquecidos.
            </p>
          </BlurFade>
        </div>
              ...
              <div className="contact-signal-board">
                <div className="contact-signal-cell">
                  ...
                  <p className="contact-signal-copy">
                    Descreva projeto, contexto ou objetivo com a sua linguagem.
                  </p>
                </div>
                <div className="contact-signal-cell">
                  ...
                  <p className="contact-signal-copy">
                    O WhatsApp abre com a mensagem pronta para voce ajustar se
                    quiser.
                  </p>
                </div>
                <div className="contact-signal-cell">
                  ...
                  <p className="contact-signal-copy">
                    Conversa iniciada no canal que realmente uso no dia a dia.
                  </p>
                </div>
              </div>
            </BlurFade>
            ...
            <BlurFade delay={120}>
              <aside className="contact-direct-panel">
                ...
                <p className="contact-direct-copy">
                  Melhor para briefing, proposta, parceria ou conversa inicial
                  sobre produto e software.
                </p>
              </aside>
            </BlurFade>
          </div>
          ...
          <div className="contact-main-column">
              ...
              <section className="contact-form-shell">
                <div className="contact-form-head">
                  <p className="contact-form-labelline">
                    <span className="text-blue-base">↓</span> WhatsApp launchpad
                  </p>
                ...
                >
                  <input type="hidden" name="phone" value={whatsappNumber} />

                  <label htmlFor="text" className="contact-field-label">
                    Mensagem
                  </label>
                  <textarea
                    id="text"
                  ...
                  <p className="contact-form-hint">
                    Ao clicar em enviar, voce sera levado ao WhatsApp com essa
                    mensagem pronta para mandar.
                  </p>

                  <button type="submit" className="contact-send-btn">
                    <span className="contact-send-icon-wrap" aria-hidden="true">
                      <WhatsAppIcon />
                    </span>
                    ENVIAR
                  </button>
            ...
            <BlurFade delay={160}>
              <section className="contact-social-shell">
                <p className="contact-form-labelline">
                  <span className="text-blue-base">↓</span> Outros pontos de
                  contato
                </p>
