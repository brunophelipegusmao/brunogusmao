...
export default async function About() {
   const [aboutExperience, aboutSkills, aboutStats] = await Promise.all([
      getAboutExperience(),
      getAboutSkills(),
      getAboutStats(),
   ]);
            ...
            <div className='relative max-w-[1400px]'>
               ...
               <BlurFade delay={500} className='about-intro-grid'>
                  <p className='about-intro-lead'>
                     Desenvolvedor Full Stack baseado no Brasil. Faço sistemas
                     que funcionam, interfaces que comunicam e código que dá
                     orgulho de manter.
                  </p>
               ...
               <div className='about-bio-grid'>
                  <BlurFade delay={100} className='about-bio-quote-wrapper'>
                     <blockquote className='about-bio-quote'>
                        "Sistemas bem construídos são invisíveis — o usuário só
                        percebe quando algo falha."
                     </blockquote>
                  ...
                  <BlurFade delay={200} className='about-bio-text-wrapper'>
                     <p className='about-bio-p'>
                        Comecei a programar por necessidade — queria criar
                        coisas que funcionassem de verdade. Com o tempo, isso
                        virou obsessão por código limpo, arquiteturas que fazem
                        sentido e interfaces que respeitam quem usa.
                     </p>
                     <p className='about-bio-p'>
                        Trabalho com o stack completo: do banco de dados à tela
                        do usuário. Tenho particular interesse em performance,
                        experiência do usuário e na interseção entre design e
                        engenharia.
                     </p>
                     <p className='about-bio-p'>
                        Quando não estou codando, estou lendo sobre sistemas,
                        explorando novas ferramentas ou contribuindo com
                  ...
                  <BlurFade delay={300} className='about-bio-visual'>
                     <div className='about-code-block' aria-hidden='true'>
                        ...
                        <p className='about-code-line about-code-indent'>
                           available:{' '}
                           <span className='text-blue-base'>true</span>
                        </p>
         ...
         <section className='px-6 sm:px-8 md:px-16 py-20 md:py-28 bg-bg-subtle border-y border-border'>
            <div className='max-w-[1400px]'>
               ...
               <div className='about-skills-grid'>
                  {Object.entries(aboutSkills).map(([category, items], i) => (
                  ...
                  {aboutExperience.map((item, i) => (
                     ...
                     <BlurFade key={i} delay={i * 120}>
                        <div className='about-timeline-item'>
                           <div
                              className='about-timeline-accent'
                              aria-hidden='true'
                           />
                           <div className='about-timeline-body'>
                              <div className='about-timeline-header'>
                                 ...
                                 <p className='about-timeline-period'>
                                    {item.period}
                                 </p>
                              </div>
                              <p className='about-timeline-company'>
                                 {item.company}
                              </p>
