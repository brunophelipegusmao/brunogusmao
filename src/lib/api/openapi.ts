      ...
      schemas: {
        AuthLoginForm: {
          ...
          properties: {
            username: {
              type: "string",
              description: "Usuário administrativo configurado via ambiente.",
              example: "admin",
            },
            password: {
              type: "string",
              format: "password",
              description: "Senha administrativa configurada via ambiente.",
    ...
    paths: {
      ...
      "/api/auth/logout": {
        post: {
          ...
          responses: {
            303: {
              description: "Sessão encerrada com redirecionamento para /login.",
              headers: {
                Location: {
                  $ref: "#/components/headers/Location",
                },
