...
export function PostManagementPanel({
  ...
  return (
    <main className="min-h-screen px-6 py-14 sm:px-8 md:px-16">
      <section className="mx-auto grid w-full max-w-6xl gap-8">
        ...
        <section className="grid gap-5 border border-border p-5">
          <header className="grid gap-1">
            ...
            <p className="text-sm text-text-secondary">
              Defina tags para busca em area privada e area publica do blog.
            </p>
          </header>
        ...
        <section className="grid gap-4 border border-border p-5">
          <header className="grid gap-1">
            ...
            <p className="text-sm text-text-secondary">
              Personalize cor de fonte, estilo tipografico e cor de fundo.
            </p>
          </header>
        ...
        <section className="grid gap-4 border border-border p-5">
          <header className="grid gap-1">
            ...
            <p className="text-sm text-text-secondary">
              Simulacao de pesquisa usando os metadados de tags aplicados aos
              posts.
            </p>
          </header>
