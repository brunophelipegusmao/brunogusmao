...
function buildInitialPostState(posts: DashboardPostSummary[]) {
  return posts.reduce<Record<string, PostRuntimeState>>((accumulator, post) => {
...
export function ManagementHub({ posts }: ManagementHubProps) {
  ...
  const [newTagBackgroundColor, setNewTagBackgroundColor] = useState("#2f5fd0");
  ...
  const sortedPosts = useMemo(() => {
    ...
    postsToSort.sort((left, right) => {
      ...
      if (sortKey === "publishedAt") {
        return (
          factor * left.publishedAt.localeCompare(right.publishedAt, "pt-BR")
        );
      }
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="grid gap-2">
              ...
              <p className="max-w-4xl text-sm text-text-secondary">
                ...
                despublicacao, revisao, exclusao e cadastro de tags com estilo
                visual.
              </p>
            </div>
            ...
            <section className="grid gap-4 border border-border p-5">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                {tagLibrary
                  ...
                  .map((tag) => {
                    const checked = selectedPost.tags.includes(tag.label);
                    ...
                    return (
                      ...
                      >
                        ...
                        <input
                          type="checkbox"
                          checked={checked}
                          onChange={() => toggleTagForSelectedPost(tag.label)}
          ...
          <DialogContent className="max-h-[88vh] w-[94vw] max-w-[94vw] overflow-y-auto rounded-none border border-border-strong bg-bg p-0 md:max-w-4xl">
            <DialogHeader className="border-b border-border p-5">
              ...
              <DialogDescription className="text-sm text-text-secondary">
                As opcoes seguem o mesmo padrao de /dashboard/posts para nome,
                estilo tipografico e cores da tag.
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <label className="grid gap-2">
                  ...
                  <input
                    ...
                    onChange={(event) => setNewTagTextColor(event.target.value)}
