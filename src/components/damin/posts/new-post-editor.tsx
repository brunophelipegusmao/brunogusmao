   ...
   const previewPost = useMemo<BlogPost>(() => {
      const coverImage = normalizedCoverSrc
         ? {
              ...
              alt:
                 coverAlt.trim() ||
                 `Capa do artigo ${title.trim() || 'sem titulo'}`,
           }
         : undefined;
                       ...
                       blocks: [
                          {
                             type: 'paragraph',
                             content:
                                'Comece escrevendo o corpo do artigo no editor.',
                          },
                       ],
                    },
                 ],
               ...
               <div className='flex flex-wrap items-start justify-between gap-3'>
                  <div className='grid gap-2'>
                     ...
                     <p className='max-w-4xl text-sm text-text-secondary'>
                        Editor estruturado para criar o conteúdo do blog sem
                        HTML livre, com suporte a tags, capa fallback e imagens
                        no meio do texto.
                     </p>
                  </div>
            ...
            <section className='grid gap-3 border border-border bg-bg-subtle p-5'>
               <div className='flex items-start gap-3'>
                  ...
                  <div className='grid gap-1 text-sm text-text-secondary'>
                     ...
                     <p>
                        O editor trabalha com texto puro e blocos estruturados.
                        HTML arbitrário não é interpretado, e URLs de imagem
                        inválidas são ignoradas no preview e no snippet
                        exportado.
                     </p>
                  </div>
               </div>
                  ...
                  <section className='grid gap-4 border border-border p-5 xl:grid-cols-2'>
                     ...
                     <label className='grid gap-2 xl:col-span-2'>
                        ...
                        <select
                           ...
                           onChange={event =>
                              setStatus(
                                 event.target.value as PostWorkflowStatus,
                              )
                           }
                           className='h-11 border border-border bg-bg px-3 text-sm text-text-primary outline-none transition-colors focus:border-blue-base'
                        >
                  ...
                  <section className='grid gap-4 border border-border p-5 xl:grid-cols-[1.3fr_0.9fr]'>
                     <div className='grid gap-4'>
                        <label className='grid gap-2'>
                           ...
                           <input
                              ...
                              value={coverSrc}
                              onChange={event =>
                                 setCoverSrc(event.target.value)
                              }
                              placeholder='https://... ou /blog/minha-capa.jpg'
                              className='h-11 border border-border bg-bg px-3 text-sm text-text-primary outline-none transition-colors focus:border-blue-base'
                           />
                           <span className='text-xs text-text-muted'>
                              Se este campo ficar vazio, o blog público usa a
                              capa padrão.
                           </span>
                           {coverSrc.trim() && !normalizedCoverSrc ? (
                              <span className='text-xs text-destructive'>
                                 Use uma URL http/https válida ou um caminho
                                 interno iniciado em /.
                              </span>
                           ) : null}
                        </label>
                     ...
                     <div className='grid gap-2'>
                        ...
                        <div className='aspect-video overflow-hidden border border-border bg-bg'>
                           <UnoptimizedImage
                              src={
                                 normalizedCoverSrc ?? DEFAULT_COVER_IMAGE.src
                              }
                  ...
                  <section className='grid gap-4 border border-border p-5'>
                     <header className='grid gap-1'>
                        ...
                        <p className='text-sm text-text-secondary'>
                           Selecione tags da biblioteca existente ou crie novas
                           tags de assunto.
                        </p>
                     </header>
                  ...
                  <section className='grid gap-4 border border-border p-5'>
                     <header className='flex flex-wrap items-center justify-between gap-3'>
                        <div className='grid gap-1'>
                           ...
                           <p className='text-sm text-text-secondary'>
                              Monte o artigo por seções e blocos. Imagens podem
                              entrar entre os textos.
                           </p>
                        </div>
                                          ...
                                          <div className='grid gap-3 xl:grid-cols-2'>
                                             <label className='grid gap-2 xl:col-span-2'>
                                                ...
                                                !normalizeMediaSource(
                                                   ...
                                                   <span className='text-xs text-destructive'>
                                                      Informe uma URL http/https
                                                      válida ou um caminho
                                                      iniciado em /.
                                                   </span>
                                                ) : null}
                                             </label>
                  ...
                  <section className='grid gap-4 border border-border p-5'>
                     ...
                     <article className='grid gap-8 border border-border bg-bg-subtle p-6'>
                        ...
                        <div className='aspect-video overflow-hidden border border-border bg-bg'>
                           <UnoptimizedImage
                              src={
                                 previewPost.coverImage?.src ??
                                 DEFAULT_COVER_IMAGE.src
                              }
                              alt={
                                 previewPost.coverImage?.alt ??
                                 DEFAULT_COVER_IMAGE.alt
                              }
                              className='h-full w-full object-cover'
                           />
                        </div>
                        ...
                        <div className='flex flex-wrap gap-2'>
                           {previewPost.tags.length > 0 ? (
                              ...
                              <p className='text-sm text-text-muted'>
                                 As tags aparecerão aqui assim que forem
                                 selecionadas.
                              </p>
                           )}
                        </div>
               ...
               <TabsContent value='snippets' className='grid gap-6'>
                  <section className='grid gap-4 border border-border p-5'>
                     <header className='grid gap-1'>
                        ...
                        <p className='text-sm text-text-secondary'>
                           Cole este objeto em src/app/(public)/blog/posts.ts
                           dentro do array blogPosts.
                        </p>
                     </header>
                     ...
                     <div className='flex flex-wrap items-center gap-3'>
                        <RippleButton
                           onClick={() =>
                              copySnippet('Snippet do post', postSnippet)
                           }
                           className='px-3 py-2'
                        >
                           <Copy /> Copiar snippet
                        ...
                        {copyFeedback ? (
                           <span className='text-sm text-blue-base'>
                              {copyFeedback}
                           </span>
                        ) : null}
                     </div>
                  ...
                  <section className='grid gap-4 border border-border p-5'>
                     <header className='grid gap-1'>
                        ...
                        <p className='text-sm text-text-secondary'>
                           Cole esta linha em src/lib/content/posts-admin.ts
                           dentro de postStatusBySlug.
                        </p>
                     </header>
                     ...
                     <RippleButton
                        onClick={() =>
                           copySnippet('Snippet de status', statusSnippet)
                        }
